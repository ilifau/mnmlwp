...
function mnmlwp_scripts_and_styles()
{
    ...
    wp_enqueue_style( 'mnmlwp-main', mnmlwp_assets_url() . '/css/main.css', array(), '0.7.0' );
}
...
function mnmlwp_admin_scripts_and_styles()
{
    ...
    // Global
    wp_enqueue_style( 'mnmlwp-admin', mnmlwp_assets_url() . '/css/admin.css', array(), '0.7.0' );
    wp_enqueue_script( 'admin', mnmlwp_assets_url() . '/js/admin/mnmlwp-admin.js', array('jquery'), '0.7.0', true );
